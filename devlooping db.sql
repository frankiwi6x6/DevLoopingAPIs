...
-- Tabla intermedia CHALLENGE_TIP para unir CHALLENGE y TIP
CREATE TABLE CHALLENGE_TIP (
	CHALLENGE_TIP_id INTEGER PRIMARY KEY AUTO_INCREMENT,
    challenge_id INTEGER NOT NULL,
    CONSTRAINT CHALLENGE_TIP_CHALLENGE_FK FOREIGN KEY (challenge_id) REFERENCES CHALLENGE(id_challenge) ON DELETE CASCADE ON UPDATE CASCADE,
    UNIQUE KEY challenge_tip_unique (challenge_id)
);
-- Definición de tabla TIP (tabla independiente)
CREATE TABLE TIP (
