...
DROP TABLE USER_POST_LIKES IF EXISTS;
DROP TABLE USER_POST_SHARES IF EXISTS;
DROP TABLE COMMENT IF EXISTS;
DROP TABLE POST IF EXISTS;
DROP TABLE POST_STATE IF EXISTS;
DROP TABLE CHALLENGE_USER IF EXISTS;
DROP TABLE ARCHIEVEMENT_USER IF EXISTS;
DROP TABLE PERMISSION_USER IF EXISTS;
DROP TABLE USER IF EXISTS;
DROP TABLE ACHIEVEMENT IF EXISTS;
DROP TABLE PERMISSION IF EXISTS;
DROP TABLE USER_TYPE IF EXISTS;
DROP TABLE CHALLENGE IF EXISTS;
DROP TABLE CHALLENGE_TYPE IF EXISTS;
DROP TABLE DIFFICULTY IF EXISTS;
DROP TABLE EXPECTED_OUTPUT IF EXISTS;
